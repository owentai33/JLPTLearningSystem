...
- Create Angular project with ng: `ng new japanesestudy.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`japanesestudy.client.esproj`).
